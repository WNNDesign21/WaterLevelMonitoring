...
<body class="min-h-screen bg-slate-100/50 font-sans antialiased selection:bg-blue-200 p-2">
    ...
    <div class="flex flex-col h-[calc(100vh-1rem)] gap-2 w-full">
        ...
        <header class="cockpit-card rounded-xl p-4 flex items-center justify-between shrink-0 border-blue-100 bg-white/90 v-reveal-top" style="--delay: 0.2s">
        ...
        <main class="flex-1 flex gap-2 min-h-0 w-full">
            ...
            <aside class="w-80 flex flex-col gap-2 shrink-0 v-reveal-left" style="--delay: 0.6s">
            ...
            <div class="flex-1 flex flex-col gap-2 min-w-0">
                ...
                <section class="flex-1 cockpit-card rounded-[3rem] p-8 border-slate-200 bg-white relative flex flex-col scanline-effect overflow-hidden shadow-2xl v-reveal-scale" style="--delay: 1.0s">
                ...
                <section class="h-40 cockpit-card rounded-2xl p-4 border-slate-200 bg-white overflow-hidden flex flex-col shadow-lg v-reveal-bottom" style="--delay: 1.8s">
            ...
            <aside class="w-80 flex flex-col gap-2 shrink-0 v-reveal-right" style="--delay: 1.4s">
                <!-- Predictive Summary -->
                <section class="cockpit-card rounded-2xl p-5 flex flex-col border-slate-200 bg-white">
