...
class _HomeViewState extends State<HomeView> {
                  ...
                  children: [
                      ...
                      onNotification: (notification) {
                        if (notification is OverscrollNotification) {
                          ...
                          if (notification.scrollDelta != null &&
                              controller.pullDistance.value > 0) {
                            controller.pullDistance.value -=
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: (controller.isLoading.value && controller.devices.isEmpty)
                                      ? Padding(
                                      ...
                                      : controller.devices.isEmpty
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const SizedBox(height: 24),
                                              _buildUnifiedMonitoringCard(
                                                  context), // Kartu Terpadu (TMA + Diagram + Status)
                                              const SizedBox(height: 24),
                    ...
                    Obx(() {
                      ...
                      final top = controller.isManualRefreshing.value
                          ? 60.0
                          : (-40.0 + controller.pullDistance.value)
                              .clamp(-40.0, 100.0);
  ...
  Widget _buildTopBar(BuildContext context, ThemeController themeController) {
    return Obx(() {
      ...
      final subColor = Color.lerp(
          Colors.white.withValues(alpha: 0.6), context.textSecondary, opacity);
      final iconColor = Color.lerp(Colors.white, AppColors.accent, opacity);
      final buttonBg = Color.lerp(
          Colors.white.withValues(alpha: 0.25), context.bgCard, opacity);
          ...
          children: [
            ...
            Expanded(
              child: Obx(() {
                ...
                final selectedDevice = controller.devices.firstWhereOrNull(
                  (d) => d.slug == selectedSlug,
                );

                final location = selectedDevice?.location ?? 'PILIH LOKASI';
                final name =
                    selectedDevice?.name ?? 'Sentuh untuk memilih node...';
                        ...
                        child: ClipRRect(
                          ...
                          child: photoUrl.isNotEmpty
                              ? Image.network(
                                  ...
                                  height: 28,
                                  fit: BoxFit.cover,
                                  errorBuilder: (_, __, ___) => _buildFallbackAvatar(textColor),
                                )
                              : _buildFallbackAvatar(textColor),
                        ),
                      );
                    }),
                  ],
  ...
  Widget _buildFallbackAvatar(Color? textColor) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: (textColor ?? Colors.white).withValues(alpha: 0.15),
        shape: BoxShape.circle,
      ),
      child: Icon(Icons.person_outline_rounded, color: textColor ?? Colors.white, size: 16),
    );
  }
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              left: 30,
              right:
                  30, // Tambahkan batas kanan agar tidak menabrak pinggir layar
              child: Obx(() {
                  ...
                  children: [
                    SizedBox(
                      width: MediaQuery.of(context).size.width *
                          0.12, // Dinamis 12% dari lebar layar
                      child: Image.network(
    ...
    return Obx(() {
      ...
      return Column(
        ...
        children: [
            ...
            children: [
              _buildInsightCard(
                ...
                subtitle: !controller.isOnline.value
                    ? 'Data Stale'
                    : (controller.distanceToGround.value < 0
                        ? 'Waspada Luber'
                        : 'Tinggi Aman'),
              ),
              _buildInsightCard(
                ...
                subtitle:
                    controller.isOnline.value ? 'Prediksi Meluap' : 'Offline',
                isAI: true,
              ),
              _buildInsightCard(
                context,
          ...
          Obx(() {
            final recommendation = controller.aiRecommendation.value;
            final status = controller.statusSiaga.value;
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Logic Engine v2.4 • Real-time Monitoring',
                            style: GoogleFonts.inter(
                              fontSize: 8,
        ...
        children: [
          Row(
            children: [
              ...
              if (isAI) 
                Icon(Icons.auto_awesome, color: color.withValues(alpha: 0.5), size: 10),
            ],
          ),
          const Spacer(),
          Row(
                      ...
                      _MapActionButton(
                        onTap: () {
                          ...
                          if (Get.isRegistered<DeviceMapController>()) {
                            ...
                            final device = dmController.devices.firstWhereOrNull(
                              (d) =>
                                  d.slug ==
                                  controller.selectedDeviceSlug.value,
                            );
                            if (device != null) {
  ...
  Widget _buildUnifiedMonitoringCard(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: AppShadows.card(context.isDark),
        border: Border.all(
            color: context.borderColor.withValues(alpha: 0.5), width: 1),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Divider(
              color: context.dividerColor.withValues(alpha: 0.4), height: 1),
          ...
          touchTooltipData: LineTouchTooltipData(
            ...
            getTooltipItems: (touchedSpots) {
              return touchedSpots.map((LineBarSpot touchedSpot) {
                final time = controller.sparklineTimestamps.length >
                        touchedSpot.spotIndex
                    ? DateFormat('HH:mm:ss').format(
                        controller.sparklineTimestamps[touchedSpot.spotIndex])
                    : '--:--:--';
                ...
                children: [
                  ...
                  Obx(() => ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final DeviceModel device = filteredDevices[index];
                          final isSelected =
                              controller.selectedDeviceSlug.value == device.slug;
                  ...
                  // Searching Overlay (Premium Radar Scan)
                  Obx(() => DeviceScanningOverlay(
                    isVisible: controller.isSearchingNode.value,
                  )),
                ],
              ),
            ),
